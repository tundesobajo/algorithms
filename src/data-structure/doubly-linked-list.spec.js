...
describe('Doubly Linked List', function () {
  ...
  describe('#insert()', function () {
    ...
    it('can insert in index 0 of 2 values', function () {
      const value = 'Two';
      assert.strictEqual(list.insert(0, value), true);
      assert.strictEqual(list.shift(), value);
      assert.strictEqual(list.shift(), 'One');
    });
    ...
    it('can insert in index 2 of 2 values', function () {
      const value = 'Two';
      assert.strictEqual(list.insert(2, value), true);
      assert.strictEqual(list.pop(), value);
      assert.strictEqual(list.pop(), 'Three');
    });
